 ...
 *
 * 说明：
 * - 功能键常量（CHAR_*）：当消息类型为 WM_CHAR_FUN 时，取消息值 param 的低字节，与功能键含义对应。
 * - 键盘扫描码（KEY_*）：当消息类型为 WM_KEY 时，取消息值 param 的低字节；由 GuiTranslateMsg 把扫描码转为字符或功能。
 */
/*******************************************************************************************
*				转换后的扩展键  ---  功能键
...
#define		KEY_EC_SJ				0x02			/* 朗文双解 */
#define		KEY_EC_SW				0x03			/* 朗文十万 */
